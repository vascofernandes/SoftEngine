module SoftEngine {
    ...
    export class Device {
        ...
        putPixel(x: number, y: number, color: BABYLON.Color4) {
        ...
        drawPoint(point: BABYLON.Vector2) {
        ...
        render(camera: Camera, meshes: Mesh[]) {
            ...
            for (let index = 0; index < meshesLength; index++) {
                // current mesh to work on
                var cMesh = meshes[index];
                // Beware to apply rotation before translation
                var worldMatrix = BABYLON.Matrix
                                    .RotationYawPitchRoll(cMesh.Rotation.y, cMesh.Rotation.x, cMesh.Rotation.z)
                                    .multiply(
                ...
                var cMeshVerticesLength = cMesh.Vertices.length;

                for (let indexVertices = 0; indexVertices < cMeshVerticesLength; indexVertices++) {
